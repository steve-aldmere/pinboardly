    ...
    <main className="min-h-screen bg-white">
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-gray-700">
          <section>
            <h2 className="text-base font-semibold text-gray-900">1. About Pinboardly</h2>
            <p className="mt-2">
              Pinboardly is a subscription service that lets you publish a simple public pinboard
              for links, notes, and events.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900">3. Subscriptions and billing</h2>
            <p className="mt-2">
